    ...
    public static class EntityHelper
    {
        ...
        public static bool EntityEquals(IEntity entity1, IEntity entity2)
        {
            ...
            if (!typeOfEntity1.IsAssignableFrom(typeOfEntity2) &&
                !typeOfEntity2.IsAssignableFrom(typeOfEntity1)) return false;
        ...
        public static void TrySetId<TKey>(IEntity<TKey> entity, Func<TKey> idFactory,
            ...
            var property = CachedIdProperties.GetOrAdd(
                $"{entity.GetType().FullName}-{checkForDisableIdGenerationAttribute}", () =>
                {
                    var idProperty = entity.GetType().GetProperties()
                        .FirstOrDefault(x => x.Name == nameof(entity.Id) && x.GetSetMethod(true) != null);
