    ...
    public abstract class AbpApplicationBase : IAbpApplication
    {
        ...
        protected virtual void ConfigureServices()
        {
            ...
            foreach (var module in Modules.Where(m => m.Instance is IPreConfigureServices))
                ...
                catch (Exception ex)
                {
                    throw new AbpInitializationException(
                        $"An error occurred during {nameof(IPreConfigureServices.PreConfigureServices)} phase of the module " +
            ...
            foreach (var module in Modules)
            {
                ...
                {
                    throw new AbpInitializationException(
                        $"An error occurred during {nameof(IAbpModule.ConfigureServices)} phase of the module" +
                        $" {module.Type.AssemblyQualifiedName}.See the inner exception for details ", ex);
                }
            }
            ...
            foreach (var module in Modules.Where(m => m.Instance is IPostConfigureServices))
                ...
                {
                    throw new AbpInitializationException(
                        $"An error occurred during {nameof(IPostConfigureServices.PostConfigureServices)} phase" +
